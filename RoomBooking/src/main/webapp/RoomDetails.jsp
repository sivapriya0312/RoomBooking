...
function rooms(){
	 var roomNumber = document.getElementById("roomNumber").value;
	  ...
	  $.ajax({
	    type: "POST",
	    url: "http://localhost:8080/RoomBooking/booking",
	    data: JSON.stringify(myData),
	    contentType: "application/json; charset=utf-8",
	    dataType: "json"
	  }); 
	window.location.replace("http://localhost:8080/RoomBooking/booking");
}
...
function booked(){
	  ...
	  $.ajax({
	    type: "POST",
	    url: "http://localhost:8080/RoomBooking/selection",
	    contentType: "application/json; charset=utf-8",
	    data:JSON.stringify(data),
	    dataType: "json"
	  });
	window.location.replace("http://localhost:8080/RoomBooking/selection");
}
